import { Bot, Home, LogOut, Users, LayoutDashboard } from 'lucide-react';
...
export function TenantShell({ onLogout }: { onLogout: () => void }) {
  ...
  const navItems = [
    { to: '/workspace/dashboard', label: t.tenantNav.home, icon: Home },
    { to: '/workspace/customers', label: t.customers.title, icon: Users },
      ...
      >
        <div className="flex w-full items-center px-6" style={{ flexDirection: isRtl ? 'row-reverse' : 'row' }}>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[13px] font-bold text-[#111111]">Apollo io</span>
          </div>
